...
class TestSingleAnnotatorWrapper(unittest.TestCase):
    ...
    def test_init_param_y_aggregate(self):
        ...
        wrapper = SingleAnnotatorWrapper(random, y_aggregate='string',
        ...
        random = RandomSampling(self.random_state)
        wrapper = SingleAnnotatorWrapper(random, y_aggregate=dummy_function,
                                         random_state=self.random_state)
    ...
    def test_query_param_candidates(self):
        random = RandomSampling(self.random_state)
        X_cand = [1, 0, 2, 4]
        wrapper = SingleAnnotatorWrapper(random,
                                         random_state=self.random_state)
    ...
    def test_query_param_query_params_dict(self):
        ...
        wrapper = SingleAnnotatorWrapper(uncertainty,
                                         random_state=self.random_state)
    ...
    def test_query_one_annotator_per_sample_batch_size_one(self):
        ...
        wrapper = SingleAnnotatorWrapper(uncertainty, y_aggregate=y_aggregate,
                                         random_state=self.random_state)
