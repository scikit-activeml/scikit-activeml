...
class LogisticRegressionRY(SkactivemlClassifier, AnnotModelMixin):
    ...
    the the bias of the annotators decisions. These estimated biases are then
    ...
    annot_prior_full : {int, float, array-like}, default=1
    ...
    annot_prior_diag : {int, float, array-like}, default=0
        ...
        true label i.
    weights_prior : {int, float}, default=1
