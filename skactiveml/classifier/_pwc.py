...
class PWC(BaseEstimator, ClassifierMixin):
    ...
    Attributes
    ----------
    classes_ : array-like, shape (n_classes), default=None (inference during fit)
        List of unique class labels.
    missing_label : number | str | None | np.nan
        Symbol to represent a missing label.
    metric : str,
    ...
    def __init__(self, classes=None, missing_label=MISSING_LABEL, metric='rbf', n_neighbors=None, cost_matrix=None,
