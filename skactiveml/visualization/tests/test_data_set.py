...
class TestFeatureSpace(unittest.TestCase):
    ...
    def test_gaussian_noise_generator_1d(self):
        ...
        noise_1 = gaussian_noise_generator_1d(
            self.X, (0, 3), default_std=default_std, random_state=self.random_state
        )
    ...
    def test_sample_generator_1d(self):
        X_1 = sample_generator_1d(9, (0, 1, 2), (1, 2), random_state=self.random_state)
        X_2 = sample_generator_1d(9, (0, 1, 2), (1, 2), random_state=self.random_state)
        ...
        X = sample_generator_1d(10, (0, 1, 2), (1, 2), random_state=self.random_state)
