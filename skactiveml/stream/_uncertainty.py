...
class FixedUncertainty(SingleAnnotStreamBasedQueryStrategy):
    ...
    def get_default_budget_manager(self, budget=None):
        ...
        """
        return FixedUncertaintyBudget(budget=budget)
...
class VariableUncertainty(SingleAnnotStreamBasedQueryStrategy):
    ...
    def get_default_budget_manager(self, budget=None):
        ...
        budget_manager : BudgetManager
            The BudgetManager that should be used by default.
        """
        return VariableUncertaintyBudget(budget=budget)
...
class RandomVariableUncertainty(SingleAnnotStreamBasedQueryStrategy):
    ...
    def get_default_budget_manager(self, budget=None):
        ...
        budget_manager : BudgetManager
            The BudgetManager that should be used by default.
        """
        return RandomVariableUncertaintyBudget(budget=budget)
...
class Split(SingleAnnotStreamBasedQueryStrategy):
    ...
    def get_default_budget_manager(self, budget=None):
        ...
        return SplitBudget(budget=budget, random_state=random_state)
