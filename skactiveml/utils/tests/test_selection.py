...
class TestSelection(unittest.TestCase):
    ...
    def test_rand_argmin(self):
        ...
        np.testing.assert_array_equal([1, 0], rand_argmin(self.d, axis=1, random_state=42))
        ...
        np.testing.assert_array_equal([1, 1], rand_argmin(self.d, axis=1, random_state=1))
    ...
    def test_rand_argmax(self):
        ...
        np.testing.assert_array_equal([1, 0], rand_argmax(self.d, axis=1, random_state=42))
        ...
        np.testing.assert_array_equal([1, 1], rand_argmax(self.d, axis=1, random_state=1))
